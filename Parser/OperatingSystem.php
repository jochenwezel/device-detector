...
class OperatingSystem extends AbstractParser
{
    ...
    protected static $osFamilies = [
        ...
        'RISC OS'               => ['RISC OS'],
        'GNU/Linux'             => [
            'GNU/Linux', 'Arch Linux', 'Debian', 'Knoppix', 'Mint', 'Ubuntu',
            'Kubuntu', 'Xubuntu', 'Lubuntu', 'Fedora', 'Red Hat', 'VectorLinux',
            'Mandriva', 'Gentoo', 'Sabayon', 'Slackware', 'SUSE', 'CentOS', 'BackTrack', 'Sailfish OS',
        ],
        'Mac'                   => ['Mac'],
